...
hi Cursor         gui=None            guibg=#add8e6    guifg=#000000 ctermfg=black
...
hi Identifier     gui=None            guibg=bg         guifg=#009acd  cterm=bold
hi Statement      gui=None            guibg=bg         guifg=#72a5ee  cterm=bold
hi PreProc        gui=None            guibg=bg         guifg=#c12869  cterm=bold ctermfg=blue
"hi Include        gui=None            guibg=bg         guifg=#ccccff  cterm=bold ctermfg=blue
hi Include        cterm=bold ctermfg=blue
hi Type           gui=None            guibg=bg         guifg=#3b9c9c  cterm=bold
...
hi ModeMsg        gui=None            guibg=#C6C5FE    guifg=black    cterm=bold,underline ctermfg=cyan
